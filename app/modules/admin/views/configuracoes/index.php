                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="logomarca" id="logomarca" class="form-control" placeholder="" />
                                        <div class="checkbox">
                                            <label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="background" id="background" class="form-control" placeholder="" />
                                        <div class="checkbox">
                                            <label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bgcolor" id="bgcolor" value="<?= $row->bgcolor ?>" class="form-control colorpicker" placeholder="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane panel panel-default" id="contato">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="texto_contato" id="texto_contato" class="form-control ckeditor"><?= $row->texto_contato; ?></textarea>
                            </div>
