...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><i class="fa fa-calendar"></i> <?= wpn_lang('module_title') ?></li>
    </ol>
</section>
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <?= anchor('admin/events/add', glyphicon('plus-sign') . wpn_lang('wpn_bot_new'), array('class' => 'btn btn-sm btn-primary')); ?>
            </div>
        </div>
        <div class="box-body">
