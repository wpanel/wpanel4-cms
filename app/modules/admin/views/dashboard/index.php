...
<section class="content">
    <div class="box">
        <div class="box-body">
            <div class="row">
                <div class="col-md-3 col-sm-3 hidden-xs"><img src="<?= $avatar; ?>" class="img-responsive img-thumbnail" alt="<?= auth_extra_data('name'); ?>"/></div>
                <div class="col-md-4 col-sm-4">
                    <h2><?= wpn_lang('wpn_hello', 'Hello'); ?> <?= auth_extra_data('name'); ?>.</h2>
                    <p><?= auth_extra_data('name'); ?> - <?= auth_login_data('email'); ?></p>
                    <p><?= wpn_lang('wpn_since', 'Since'); ?> <?= datetime_for_user(auth_login_data('created_on'), 0); ?></p>
