...
class Migration_Database_inicial extends CI_Migration {
	...
	public function up()
	{
		...
		$this->dbforge->add_field("`youtube_rss` varchar(200) DEFAULT NULL");
